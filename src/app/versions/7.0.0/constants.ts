...
export const LAMBDA_FUNCTION_NAME =
  "remotion-render-4-0-340-mem2048mb-disk2048mb-900sec";
...
// Render duration limit (5 minutes in frames) - enforced during rendering
export const RENDER_DURATION_LIMIT_FRAMES = 5 * 60 * FPS; // 5 minutes
