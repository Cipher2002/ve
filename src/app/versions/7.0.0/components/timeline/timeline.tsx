...
const Timeline: React.FC<TimelineProps> = ({
  ...
  //         // If it's a regular URL, fetch it normally
  //         const response = await fetch(videoOverlay.src);
  //         if (!response.ok) {
  ...
  //       // Create new sound overlay with extracted audio
  ...
  //       // Update overlays with shifted rows and new sound
  //       setOverlays([...updatedOverlaysWithDetachedVideo, newSoundOverlay as any]);
  ...
  //         // Fallback to random sound if extraction fails
  ...
  //         // IMPORTANT: Also mark video as detached in the fallback case
  //         const updatedVideoOverlay = {
  //           ...videoOverlay,
  //           audioDetached: true,
  //         };
