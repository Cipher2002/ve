      ...
      <div className="relative flex flex-col items-center justify-center space-y-2 min-h-[50px]">
        ...
        <div className="w-12 h-10 relative flex items-center justify-center overflow-hidden">
          ...
          >
            {/* Main 3D Element */}
            <div
              className="w-10 h-8 bg-gradient-to-br from-sky-200 to-sky-700 rounded border border-slate-400/30 shadow-sm"
              style={{
            ...
            {previewTransform.transform && previewTransform.transform !== "none" && (
              <div
                className="absolute w-10 h-6 bg-gradient-to-br from-slate-400/40 to-slate-600/40 rounded border border-slate-500/20 shadow-sm"
                style={{
        ...
        <div className="text-center w-full pt-1 border-t border-border/30">
          <div className="text-[9px] text-muted-foreground font-light leading-tight px-1">
            {layout.name}
          </div>
        </div>
      </div>
