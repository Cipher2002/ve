        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              variant="ghost"
              size="icon"
              className="h-8 w-8 sm:h-6 sm:w-6 text-[var(--text-secondary)] hover:bg-[var(--interactive-hover)]"
          ...
          <TooltipContent
            side="top"
            sideOffset={5}
            className="bg-[var(--surface-elevated)] text-xs px-2 py-1 rounded-md z-[9999] border border-[var(--border)]"
            align="center"
          >
            <span className="text-[var(--text-primary)]">Zoom Out</span>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      ...
      <TooltipProvider delayDuration={50}>
        <Tooltip>
          ...
          <TooltipContent
            ...
            align="center"
          >
            <span className="text-[var(--text-primary)]">Zoom In</span>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
