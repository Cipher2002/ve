...
export const TimelineItemResizeHandles: React.FC<TimelineItemResizeHandlesProps> = ({
  ...
  const baseHandleClasses = `
    ...
    bg-[var(--timeline-handle-bg)] backdrop-blur-sm
    hover:bg-[var(--timeline-handle-hover)] 
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="space-x-0.5 flex ml-0">
            <div className="w-[1px] h-4 bg-[var(--timeline-handle-indicator)] rounded-full shadow-glow" />
            <div className="w-[1px] h-4 bg-[var(--timeline-handle-indicator)] rounded-full shadow-glow" />
          </div>
        </div>
      </div>
