...
export const TimelineInsertionLine: React.FC<TimelineInsertionLineProps> = ({
  ...
  return (
    <div
      className="absolute left-0 right-0 border-t border-[var(--primary)] pointer-events-none transition-[top] duration-75"
      style={
        insertionIndex === trackCount
          ? { bottom: 0, zIndex: 60 }
          : {
              top: `${TIMELINE_CONSTANTS.MARKERS_HEIGHT + insertionIndex * TIMELINE_CONSTANTS.TRACK_HEIGHT}px`,
              zIndex: 60,
            }
      }
    />
